...
from sqlalchemy import Column, Integer, String, Enum, Time, Date, ForeignKey, BigInteger
...
class Route(Base):
	...
	start = Column(ARRAY(BigInteger), nullable=False)
	stop = Column(ARRAY(BigInteger), nullable=False)
